...
CREATE TABLE "MOVIE" (
   ...
   "MV_POSTER"   NUMBER      NOT NULL,
   "MV_PREVIEW"   NUMBER      NOT NULL,
...
COMMENT ON COLUMN "MOVIE"."MV_POSTER" IS '영화메인포스터 파일번호';

COMMENT ON COLUMN "MOVIE"."MV_PREVIEW" IS '영화메인예고편 파일번호';
...
COMMENT ON COLUMN "PERSON"."P_FILE" IS '첨부파일번호';
...
CREATE TABLE "REVIEW" (
   ...
   "AGREE_COUNT"   NUMBER   DEFAULT 0   NULL,
   "DISAGREE_COUNT"   NUMBER   DEFAULT 0   NULL,
   "MEM_NO"   NUMBER      NOT NULL,
   "MV_NO"   NUMBER      NOT NULL
);
...
COMMENT ON COLUMN "REVIEW"."AGREE_COUNT" IS '공감 개수';

COMMENT ON COLUMN "REVIEW"."DISAGREE_COUNT" IS '비공감 개수';
...
CREATE TABLE "NO_MOVIE_ENROLL" (
   ...
   "MEM_NO"   NUMBER      NOT NULL,
   "ADMIN_NO"   NUMBER      NULL,
   "NM_POSTER"   NUMBER      NOT NULL,
   "NM_PREVIEW"   NUMBER      NOT NULL
);
...
ALTER TABLE "NO_MOVIE_ENROLL" ADD CONSTRAINT "PK_NO_MOVIE_ENROLL" PRIMARY KEY (
   "NM_ENROLL_NO"
);
...
ALTER TABLE "NO_MOVIE_GENRE" ADD CONSTRAINT "PK_NO_MOVIE_GENRE" PRIMARY KEY (
   "NM_GENRE_NO"
);
...
ALTER TABLE "NO_MOVIE_CAST" ADD CONSTRAINT "PK_NO_MOVIE_CAST" PRIMARY KEY (
   "NM_CAST_NO"
);

ALTER TABLE "REPORTED_MEM" ADD CONSTRAINT "FK_MEMBER_TO_REPORTED_MEM_1" FOREIGN KEY (
   "MEM_NO"
)
REFERENCES "MEMBER" (
   "MEM_NO"
...
ALTER TABLE "REPORTED_MEM" ADD CONSTRAINT "FK_ADMIN_TO_REPORTED_MEM_1" FOREIGN KEY (
   "ADMIN_NO"
)
REFERENCES "ADMIN" (
   "ADMIN_NO"
...
ALTER TABLE "NO_MOVIE_ENROLL" ADD CONSTRAINT "FK_MEMBER_TO_NO_MOVIE_ENROLL_1" FOREIGN KEY (
   "MEM_NO"
)
REFERENCES "MEMBER" (
   "MEM_NO"
...
ALTER TABLE "NO_MOVIE_ENROLL" ADD CONSTRAINT "FK_ADMIN_TO_NO_MOVIE_ENROLL_1" FOREIGN KEY (
   "ADMIN_NO"
)
REFERENCES "ADMIN" (
   "ADMIN_NO"
...
ALTER TABLE "MOVIE_CATEGORY" ADD CONSTRAINT "FK_MOVIE_TO_MOVIE_CATEGORY_1" FOREIGN KEY (
   "MV_NO"
)
REFERENCES "MOVIE" (
   "MV_NO"
...
ALTER TABLE "MOVIE_CATEGORY" ADD CONSTRAINT "FK_C_TO_MOVIE_CATEGORY_1" FOREIGN KEY (
   "CATEGORY_NO"
)
REFERENCES "CATEGORY" (
   "CATEGORY_NO"
...
ALTER TABLE "NO_MOVIE_GENRE" ADD CONSTRAINT "FK_C_TO_NO_MOVIE_GENRE_1" FOREIGN KEY (
   "CATEGORY_NO"
)
REFERENCES "CATEGORY" (
   "CATEGORY_NO"
...
ALTER TABLE "NO_MOVIE_GENRE" ADD CONSTRAINT "FK_NM_ENROLL_TO_NM_GENRE_1" FOREIGN KEY (
   "NM_ENROLL_NO"
)
...
ALTER TABLE "NO_MOVIE_CAST" ADD CONSTRAINT "FK_PERSON_TO_NO_MOVIE_CAST_1" FOREIGN KEY (
   "PERSON_NO"
)
REFERENCES "PERSON" (
   "P_NO"
...
ALTER TABLE "NO_MOVIE_CAST" ADD CONSTRAINT "FK_NM_ENROLL_TO_NM_CAST_1" FOREIGN KEY (
   "NM_ENROLL_NO"
)
REFERENCES "NO_MOVIE_ENROLL" (
   "NM_ENROLL_NO"
...
ALTER TABLE MEMBER ADD (DORMANT_STATUS CHAR(1));
ALTER TABLE MEMBER MODIFY (DORMANT_STATUS DEFAULT 'N');

ALTER TABLE NOTICE ADD (NOTICE_FIX CHAR(1));
ALTER TABLE NOTICE MODIFY (NOTICE_FIX DEFAULT 'N');

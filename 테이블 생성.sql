...
CREATE TABLE "MEMBER" (
	"MEM_NO"	NUMBER		NOT NULL,
	"MEM_ID"	VARCHAR2(25)		UNIQUE NOT NULL,
...
CREATE TABLE "MOVIE" (
	"MV_NO"	NUMBER		NOT NULL,
	"MV_NAME"	VARCHAR2(500)		UNIQUE NOT NULL,
...
ALTER TABLE "REPORTED_MEM" ADD CONSTRAINT "FK_AD_TO_REPD_MEM_1" FOREIGN KEY (
	"ADMIN_NO"
)
REFERENCES "ADMIN" (
	"ADMIN_NO"
...
ALTER TABLE "MOVIE_LIKE" ADD CONSTRAINT "FK_M_TO_M_LIKE_1" FOREIGN KEY (
	"MV_NO"
)
REFERENCES "MOVIE" (
	"MV_NO"
...
ALTER TABLE "MOVIE_LIKE" ADD CONSTRAINT "FK_MEM_TO_M_LIKE_1" FOREIGN KEY (
	"MEM_NO"
)
REFERENCES "MEMBER" (
	"MEM_NO"
...
ALTER TABLE "NO_MOVIE_ENROLL" ADD CONSTRAINT "FK_MEM_TO_NM_EN_1" FOREIGN KEY (
	"MEM_NO"
)
REFERENCES "MEMBER" (
	"MEM_NO"
...
ALTER TABLE "NO_MOVIE_ENROLL" ADD CONSTRAINT "FK_AD_TO_NM_EN_1" FOREIGN KEY (
	"ADMIN_NO"
)
REFERENCES "ADMIN" (
	"ADMIN_NO"
...
ALTER TABLE "MOVIE_CATEGORY" ADD CONSTRAINT "FK_M_TO_M_CG_1" FOREIGN KEY (
	"MV_NO"
)
REFERENCES "MOVIE" (
	"MV_NO"
...
ALTER TABLE "MOVIE_CATEGORY" ADD CONSTRAINT "FK_CG_TO_M_CGY_1" FOREIGN KEY (
	"CATEGORY_NO"
)
REFERENCES "CATEGORY" (
	"CATEGORY_NO"
...
ALTER TABLE "NO_MOVIE_CAST" ADD CONSTRAINT "FK_P_TO_NM_CAST_1" FOREIGN KEY (
	"PERSON_NO"
)
REFERENCES "PERSON" (
	"P_NO"
...
ALTER TABLE PERSON MODIFY (P_FILE VARCHAR2(300) NULL);

-- 배역이 긴 경우가 있어서 크기 늘림
ALTER TABLE CASTING MODIFY (CASTING VARCHAR2(100));

-- 2024.03.21 (김지우) 없는영화 테이블 포스터 컬럼, 이미지 컬럼 데이터타입 수정
ALTER TABLE NO_MOVIE_ENROLL MODIFY NM_POSTER VARCHAR2(300);
ALTER TABLE NO_MOVIE_ENROLL MODIFY NM_PREVIEW VARCHAR2(300);
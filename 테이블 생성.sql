...
CREATE TABLE "MEMBER" (
	...
	"MEM_COLOR"	VARCHAR2(40)	DEFAULT '#EB2A83'	NULL,
...
ALTER TABLE PERSON
ADD P_STATUS CHAR(1) DEFAULT 'Y';

COMMENT ON COLUMN 
PERSON.P_STATUS IS 'Y/N';

ALTER TABLE PERSON MODIFY (P_JOB VARCHAR2(90 BYTE));
ALTER TABLE PERSON MODIFY (P_NAME VARCHAR2(90 BYTE));

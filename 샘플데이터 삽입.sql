...
INSERT INTO MOVIE VALUES(SEQ_MOVIE_NO.NEXTVAL, '고질라 X 콩 : 뉴 엠파이어', '2024-03-27', '2', '115분', '고질라 X 콩, 이번에는 한 팀이다! "고질라" VS "콩", 두 타이탄의 전설적인 대결 이후 할로우 어스에 남은 "콩"은 드디어 애타게 찾던 동족을 발견하지만 그 뒤에 도사리고 있는 예상치 못한 위협에 맞닥뜨린다.', 'N', '12세 관람가', 'Y', 'N', 'resources/upfiles/20240320135136_84748.webp', 'resources/upfiles/20240320135135_84743.mp4', 'Y', SYSDATE);
INSERT INTO MOVIE VALUES(SEQ_MOVIE_NO.NEXTVAL, '댓글부대', '2024-03-27', '1', '109분', '실력 있지만 허세 가득한 사회부 기자 ‘임상진’ 대기업 ‘만전’의 비리를 취재하지만 오보로 판명되며 정직당한다.', 'N', '15세 관람가', 'Y', 'N', 'resources/upfiles/20240320135136_84743.webp', 'resources/upfiles/20240320135136_84744.mp4', 'Y', SYSDATE);
...
INSERT INTO MOVIE VALUES(SEQ_MOVIE_NO.NEXTVAL, '비키퍼', '2024-04-03', '2', '105분', '법 위에 있는 비밀 기관 "비키퍼" 그곳의 전설로 남은 탑티어 에이전트 "애덤 클레이"는 기관의 눈을 피해 자취를 감추고 양봉가로 살아간다.', 'N', '청소년 관람불가', 'A', 'N', 'resources/upfiles/20240320135135_94742.webp', 'resources/upfiles/20240320135135_94743.mp4', 'Y', SYSDATE);
...
INSERT INTO MOVIE VALUES(SEQ_MOVIE_NO.NEXTVAL, '오멘: 저주의 시작', '2024-04-03', '2', '119분', '수녀가 되기 위해 로마에 가게 된 ‘마거릿’(넬 타이거 프리). 그곳에서 새로운 삶을 시작하려는 그때, 믿음을 뒤흔드는 어둠의 그림자를 마주한다.', 'N', '15세 관람가', 'A', 'N', 'resources/upfiles/20240320135136_04744.webp', 'resources/upfiles/20240320135136_04745.mp4', 'Y', SYSDATE);
...
INSERT INTO ATTACHMENT VALUES (SEQ_ATTACHMENT_NO.NEXTVAL, '남은 인생 10년.jpeg', '20240322135135_84751.jpeg', SYSDATE, 1, 'resources/upfiles/', 1, 'Y', '1', 44);
...
INSERT INTO ATTACHMENT VALUES (SEQ_ATTACHMENT_NO.NEXTVAL, '비키퍼.webp', '20240320135135_94742.webp', SYSDATE, 1, 'resources/upfiles/', 1, 'Y', '1', 45);
...
INSERT INTO ATTACHMENT VALUES (SEQ_ATTACHMENT_NO.NEXTVAL, '오멘: 저주의 시작.webp', '20240320135136_04744.webp', SYSDATE, 1, 'resources/upfiles/', 1, 'Y', '1', 47);
...
INSERT INTO REPORT VALUES(SEQ_REPORT_NO.NEXTVAL, '2', '댓글 도배', '2024-03-22', 5, 3, '2', 3);
INSERT INTO REPORT VALUES(SEQ_REPORT_NO.NEXTVAL, '3', '선정성 댓글', '2024-03-24', 2, 7, '2', 1);
INSERT INTO REPORT VALUES(SEQ_REPORT_NO.NEXTVAL, '4', '스포일러 댓글', '2024-03-26', 2, 8, '2', 2);
INSERT INTO REPORT VALUES(SEQ_REPORT_NO.NEXTVAL, '1', '욕설 댓글', '2024-03-27', 4, 9, '2', 4);
INSERT INTO REPORT VALUES(SEQ_REPORT_NO.NEXTVAL, '4', '스포일러 게시글', '2024-03-27', 2, 6, '1', 9);
INSERT INTO REPORT VALUES(SEQ_REPORT_NO.NEXTVAL, '1', '욕설 댓글', '2024-03-27', 12, 14, '2', 9);
...
UPDATE BOARD SET B_RECOMMEND_COUNT = B_RECOMMEND_COUNT + 5;

INSERT INTO MOVIE_LIKE (LIKE_MOVIE_NO, MV_NO, MEM_NO)
...
INSERT INTO BOARD(B_NO, B_TITLE, B_CONTENT, B_READ_COUNT, B_RECOMMEND_COUNT, B_CATEGORY, MEM_NO)
VALUES(SEQ_BOARD_NO.NEXTVAL, '화녀 재밌음??', '화녀 아직 안봤는데 재밌음???', 34, 13, '1', 18);

INSERT INTO BOARD(B_NO, B_TITLE, B_CONTENT, B_READ_COUNT, B_RECOMMEND_COUNT, B_CATEGORY, MEM_NO)
VALUES(SEQ_BOARD_NO.NEXTVAL, '서울의봄 충격이 가시질 않네', '아직도 생각남...', 31, 21, '1', 20);

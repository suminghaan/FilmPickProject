...
/**
 * Servlet implementation class NoticeSearchListController
 */
...
public class NoticeSearchListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new NoticeService().keywordSelectListCount(keyword);
		...
		List<Notice> list = new NoticeService().selectKeywordList(pi, keyword);

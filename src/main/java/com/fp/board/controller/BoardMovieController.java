...
/**
 * Servlet implementation class BoardMovieController
 */
@WebServlet("/movie.bo")
public class BoardMovieController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardMovieController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/community/moviePost.jsp").forward(request, response);
	}

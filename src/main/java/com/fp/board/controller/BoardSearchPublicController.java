...
/**
 * Servlet implementation class BoardSearchPublicController
 */
@WebServlet("/searchPublic.bo")
public class BoardSearchPublicController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardSearchPublicController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new BoardService().publicKeywordSelectListCount(keyword);
		...
		List<Board> publicList = new BoardService().selectKeywordPublicList(pi, keyword);
		...
		// 응답페이지 => /views/community/searchPublicMovieList.jsp
		...
		request.getRequestDispatcher("/views/community/searchPublicMovieList.jsp").forward(request, response);
	}

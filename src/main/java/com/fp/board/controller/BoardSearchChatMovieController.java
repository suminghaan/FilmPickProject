...
/**
 * Servlet implementation class BoardSearchChatMovieController
 */
@WebServlet("/searchChatMovie.bo")
public class BoardSearchChatMovieController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardSearchChatMovieController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new BoardService().keywordSelectChatListCount(keyword);
		...
		List<Board> chatList = new BoardService().selectKeywordChatList(pi, keyword);
		...
		// 응답페이지 => /views/community/searchChatMovieList.jsp
		...
		request.getRequestDispatcher("/views/community/searchChatMovieList.jsp").forward(request, response);
	}

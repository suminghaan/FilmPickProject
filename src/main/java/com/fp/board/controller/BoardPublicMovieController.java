...
/**
 * Servlet implementation class BoardPublicMovieController
 */
@WebServlet("/publicMovie.bo")
public class BoardPublicMovieController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardPublicMovieController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// listCount : 총 인기게시글 갯수 (db로부터 조회)
		listCount = new BoardService().publicSelectListCount();
		...
		List<Board> publicList = new BoardService().selectPublicList(pi);
		...
		// 응답페이지 => /views/community/publicMoviePost.jsp
		...
		request.getRequestDispatcher("/views/community/publicMoviePost.jsp").forward(request, response);
	}

...
/**
 * Servlet implementation class ComuReportBoardListController
 */
@WebServlet("/reportBoardList.co")
public class ComuReportBoardListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ComuReportBoardListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new CommunityService().reportBoardListCount();

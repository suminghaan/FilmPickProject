...
<meta charset="utf-8">
    ...
    <link href="../ad_resources/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="../ad_resources/css/sb-admin-2.min.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-info-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="관리자메인페이지.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="utilities-color.html">신규영화 등록</a>
                        <a class="collapse-item" href="utilities-border.html">등록된영화 조회</a>
                        <a class="collapse-item" href="utilities-animation.html">영화 카테고리 관리</a>
                        <a class="collapse-item" href="utilities-other.html">메인페이지 노출영화 선택</a>
    ...
    <script src="../ad_resources/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="../ad_resources/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="../ad_resources/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../ad_resources/js/demo/chart-area-demo.js"></script>
    <script src="../ad_resources/js/demo/chart-pie-demo.js"></script>

        ...
        <form action="" method="">
            <div class="all">                
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mTitle" name="" placeholder="제목입력">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="mContent" rows="3" name=""></textarea>
                </div>
                ...
                <div class="form-group">
                    첫 페이지 노출 선택여부 : 
                    <br>
                    <input type="radio" name="gender" value="X" checked> 
                    선택안함

                    <input type="radio" id="radioM" name="gender" value="M">
                    <label for="radioM">첫페이지 노출</label>

                    <button type="button" class="btn btn-outline-secondary" style="float: right;" data-toggle="modal" data-target="#submitModal">업로드</button>
                </div>
            </div>
        </form>
    </div>

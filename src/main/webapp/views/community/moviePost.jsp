        ...
        <div class="background">
            ...
            <ul class="pagination justify-content-center">
                ...
                <% }else{ %>
                	...
                	<li class="page-item"><a class="page-link" href="<%= contextPath %>/movie.bo?page=<%= pi.getCurrentPage() - 1%>">Previous</a></li>
                <% } %>
                ...
                <li class="page-item disabled"><a class="page-link" href="#">Next</a></li>
 				<%}else{ %>
                <li class="page-item"><a class="page-link" href="<%= contextPath%>/movie.bo?page=<%=pi.getCurrentPage()+1%>">Next</a></li>
 				<%} %>
            </ul>

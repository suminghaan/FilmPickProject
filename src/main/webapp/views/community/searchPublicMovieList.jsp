...
<body>
	...
	<!-- 컨텐츠 부분 시작 -->
    <section class="content_wrap" style="background: black; min-height: 1700px;">
        ...
        <div class="background">
            ...
            <div class="community_search">
             ...
             -->
            <br><br><br>
                <span class="all_comunity" onclick="allComu();">[영화] 인기 게시글</span>
            <br><br>
            ...
            <ul class="pagination justify-content-center" style="margin-top: 10px;">
                ...
                <% }else{ %>
                	...
                	<li class="page-item"><a class="page-link" href="<%= contextPath %>/searchPublic.bo?page=<%= pi.getCurrentPage() - 1%>&searchKeyword=<%=keyword%>">Previous</a></li>
                <% } %>
                <% for(int p=pi.getStartPage(); p<=pi.getEndPage(); p++){ %>
               		<%if(p == pi.getCurrentPage()){ %>
               		<li class="page-item active"><a class="page-link" href="#"><%= p %></a></li>
               		<%}else{ %>
               		<li class="page-item"><a class="page-link" href="<%= contextPath %>/searchPublic.bo?page=<%= p %>&searchKeyword=<%=keyword%>"><%= p %></a></li>
               		<% } %>
                <% } %>
                ...
                <li class="page-item disabled"><a class="page-link" href="#">Next</a></li>
 				<%}else{ %>
                <li class="page-item"><a class="page-link" href="<%= contextPath%>/searchPublic.bo?page=<%=pi.getCurrentPage()+1%>&searchKeyword=<%=keyword%>">Next</a></li>
 				<%} %>
            </ul>

...
<%
	Movie movie = (Movie)request.getAttribute("m");
...
<body>
  <main>
	...
	<link rel="stylesheet" href="<%= contextPath %>/resources/css/starRating.css"></link>
	            ...
	            <div class="movieLikeDislike">
	              <div class="thumb_btn" style="display: flex;">
	                ...
	                <div class="thumb_count">
	                  <span style="font-size: 8px; padding-left: 0px;">공감</span>
	                </div>
	                <!-- 공감 -->
	                ...
	                <div class="thumb_count">
	                  <span style="font-size: 8px; padding-left: 0px;">비공감</span>
	                </div>
	                <!-- 비공감 -->
	              </div>
	            </div>

      ...
      <div class="content">
        ...
        <div class="test1">
            <div class="test2">
                ...
                <div class="movieExplanation"></div>
            </div>
            ...
            <div class="test3">
                ...
                <div class="movieRewiew">
                    <div class="movieReviewDetail">리뷰남기는곳 리뷰리뷰!!</div>
                    <button class="btnEdit" id="btnEdit">수정하기</button> 
                </div>

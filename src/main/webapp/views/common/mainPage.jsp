            ...
            <div id="wrap">
                <div id="main">
                    <div id="main_movie" class="carousel slide">
                        ...
                        <a class="carousel-control-prev" href="#main_movie" type="button" data-bs-target="#main_movie" style="margin-left: -50px; justify-content: center;"
                            data-bs-slide="prev">
                            <span><i class="fa-solid fa-arrow-left" style="color: #ffffff;"></i></span>

                        </a>
                        <a class="carousel-control-next" href="#main_movie" type="button" data-bs-target="#main_movie" style="margin-right: -50px; justify-content: center;"
                            data-bs-slide="next">
                            <span><i class="fa-solid fa-arrow-right" style="color: #ffffff;"></i></span>
                    ...
                    <div class="commu box">
                        ...
                        <div class="commu_box">
                            ...
                            <div class="movePage">
                                <a href=""><img src="../../resources/img/right_icon.png" alt="up_icon"></a>
                            </div>
                        </div>
                        <div class="box_font">
                            <a href="">최신등록 리뷰</a>
                        ...
                        <div id="review" class="carousel slide">
                            ...
                            <div class="movePage">
                            <a class="carousel-control-next" href="#review" type="button" data-bs-target="#review" style="justify-content: flex-end;"
                                data-bs-slide="next">
                                <img src="../../resources/img/right_icon.png" alt="up_icon"></a>
                            </a>
                            </div>
                        </div>
                        <!-- <div class="review">
                    ...
                    <div class="topPage">
                        <a href="#wrap"><img src="../../resources/img/up_icon.png" alt="up_icon"
                                style="width: 50px;"></a>
                    </div>
